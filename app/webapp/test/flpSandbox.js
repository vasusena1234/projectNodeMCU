					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "IOTApp",
									"targetURL": "#notificationapp-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"notificationapp-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=notification.app",
									"url": sap.ui.require.toUrl("notification/app")
								}
							}
						}
					}
